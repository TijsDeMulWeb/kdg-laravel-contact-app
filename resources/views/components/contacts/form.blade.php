...
<form action="/contacts/store" method="POST">
    ...
    <div class="border-b border-gray-900/10 pb-12 dark:border-white/10 m-3">
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div class="sm:col-span-3">
                <label for="firstName" class="block text-sm/6 font-medium text-gray-900 dark:text-white">First
                    name</label>
                <div class="mt-2">
    ...
    <div class="mt-6 flex items-center justify-end gap-x-6">
        <a href="{{ url()->previous() }}" class="text-sm/6 font-semibold text-gray-900 dark:text-white">
            Cancel
        </a>
        <button type="submit"
